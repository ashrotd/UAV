...
#include <vector>
#include <memory>
#include "GLViewFinalProjectCode.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFinalProjectCode > glView( Aftr::GLViewFinalProjectCode::New( args ) );
